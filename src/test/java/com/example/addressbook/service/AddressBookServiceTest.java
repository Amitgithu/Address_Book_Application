...
class AddressBookServiceTest {
    ...
    void setUp() {
        ...
        addressBook.setFirstName("Amit");
        addressBook.setLastName("Kumar");
        addressBook.setEmail("amit909563@gmail.com");
        addressBook.setAddress("Mathura, India");
    ...
    void testGetAddressBookData() {
        ...
        assertEquals("amit909563@gmail.com", result.get(0).getEmail());
    }
    ...
    void testGetAddressBookDataById() {
        ...
        assertEquals("amit909563@gmail.com", result.getEmail());
    }
